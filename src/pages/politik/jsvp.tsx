...
const questionPage = {
  ...
  content: [
    ...
    },
    {
      ...
      response: "Maßnahmen zur Stärkung der Energieunabhängigkeit werden unterstützt, u.a. durch den Ausbau der Kernenergie, die Förderung erneuerbarer Energien und die Reduzierung der Importabhängigkeit.",
      source: "",
    },
    {
      question: "Braucht die Schweiz Atomkraftwerke?",
      response: "Die Nutzung der Kernenergie wird von der Junge SVP befürwortet, insbesondere wenn sie zur Energieunabhängigkeit und zur wirtschaftlichen Stabilität beiträgt.",
      source: "",
    },
    {
      question: "Welche Vorteile sehen Sie in Atomkraft?",
      response: "Vorteile werden in der effizienten Energieerzeugung, der Verringerung der Abhängigkeit von fossilen Brennstoffen und der Unterstützung der Energieunabhängigkeit gesehen.",
      source: "",
    },
    {
      question: "Was braucht es, um die Bevölkerung von Atomkraft zu überzeugen?",
      response: "Aufklärung über die Sicherheit und Effizienz der Atomkraft sowie deren Rolle bei der Gewährleistung der Energieunabhängigkeit könnte ein Ansatz sein.",
      source: "",
    },
    {
      ...
      response: "Die Förderung von Forschung und Entwicklung im Energiebereich wird unterstützt, vor allem wenn sie zu mehr Unabhängigkeit und Wirtschaftskraft beiträgt.",
      source: "",
    },
  ],
};
