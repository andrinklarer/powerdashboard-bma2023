...
const questionPage = {
  ...
  content: [
    ...
    },
    {
      ...
      /* erweitere text hier */
      response: "Die EDU stuft die aktuelle Stromversorgungslage in der Schweiz als besorgniserregend ein, da die Versorgungssicherheit als \"grösstes Risiko mit dem größten Schadenspotenzial für die Schweiz\" angesehen wird.",
      source: "",
    },
    {
      ...
      /* erweitere text hier */
      response: "Die Elektrizitätsversorgung gehört aus Sicht der EDU [...] zum Bereich des Service public und muss in der öffentlichen Hand bleiben. [...] Die EDU unterstützt eine Optimierung der Nutzung der Wasserkraft für die Produktion von elektrischer Energie in der Schweiz.",
      source: "",
    },
    {
      question: "Braucht die Schweiz Atomkraftwerke?",
      /* erweitere text hier */
      response: "Ja, es soll in weitere investiert werden. Wollen wir unseren Wohlstand, der massgeblich auf der Verfügbarkeit von (günstiger) Energie und Strom beruht, nicht aufs Spiel setzen, kann auf die Nutzung von Kernenergie zumindest mittelfristig nicht verzichtet werden.",
      source: "",
    },
    {
    ...
    },
    {
      ...
      /* erweitere text hier */
      response: "Information über technologische Fortschritte und Sicherheitsmaßnahmen in der Kernenergie wichtig sind",
      source: "",
    },
    {
